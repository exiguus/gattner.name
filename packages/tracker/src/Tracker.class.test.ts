...
describe('Track Class', () => {
  ...
  test('create', () => {
    ...
    expect(JSON.stringify(tracker.getStore())).toBe(
      `{\"type\":\"test\",\"msg\":\"create item\",\"value\":\"test: create item\",\"timestamp\":${timestamps[0]},\"pid\":1,\"name\":\"test-env\",\"url\":\"http://localhost/\",\"navigator\":\"Mozilla/5.0 (linux) AppleWebKit/537.36 (KHTML, like Gecko) jsdom/20.0.3\",\"origin\":\"http://localhost\",\"referrer\":\"\",\"fingerprint\":${fingerprint}}`
    )
